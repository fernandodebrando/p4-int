...
control MyIngress(inout headers hdr,
    ...
    //     hdr.int_headers[0].ingress_tstamp = (bit<32>) standard_metadata.enq_timestamp;
    // }
...
control MyEgress(inout headers hdr,
    ...
    action add_int_header(switch_id_t swid){
        ...
        //hdr.int_headers[0].egress_tstamp = (bit<32>) standard_metadata.enq_timestamp + (bit<32>) standard_metadata.deq_timedelta;
